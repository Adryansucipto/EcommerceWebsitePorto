<?php
    ...
    $brand = searchPagebyBrand($idbrand);
    ...
    $items= query("SELECT p.id,p.name,p.price,bp.name as brand,p.stars,p.img,p.description,p.color FROM products p JOIN brandproduct bp ON p.brand = bp.id where bp.name LIKE '%$idbrand%'");
...
<head>
    ...
    <link rel="stylesheet" href="./css/productperbrand.css">

    <script src="./js/slide.js" async></script>
    <title>ProductPagePerBrand | ECommerceStore</title>
</head>
...
<body>
    ...
    <nav>
        ...
        <div class="latest">
                <h3 id="title"><?=$idbrand.' Brands'?></h3>
                <br>
                <div class="descriptionbrand">
                    <img src="./img/<?=$brand['img']?>" alt="">
                    <div class="desc">
                        <p><?=$brand['description']?></p>
                    </div>
                    <a href="<?=$brand['link_website']?>" target="_blank" id="btn_readMore">Read More</a>               
                </div>
                <br>
    ...
    <?php if($idbrand=='Apple'):?>
        <script src="js/searchbrand1.js"></script>
    <?php endif; ?>
    <?php if($idbrand=='Samsung'):?>
        <script src="js/searchbrand2.js"></script>
    <?php endif; ?>
    <?php if($idbrand=='Xiaomi'):?>
        <script src="js/searchbrand3.js"></script>
    <?php endif; ?>
</body>
</html>